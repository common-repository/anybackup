...
No longer supported.  Please use a different backup tool.
...
* Fix activation syntax error for PHP 5.2/5.3

=1.3.6=

* New Feature - Display backup logs
* Fix for binary sql
* New 10MB limit for individual files on the free plan
* Several other bug fixes

=1.3.5=

* Fixed a bug with php 5.2
* Fixed a bug preventing some users from modifying settings

=1.3.4=

* Fixed a migration bug with very large sites
