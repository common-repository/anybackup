...
$GLOBALS["BITS_ANYBACKUP_PLUGIN_VERSION"] = "1.3.7";
...
function anybackup_render_backup() {
  if(isset($_GET['runSpecs'])) {
    anybackup_render('../spec/bits-backup-spec.php');
...
?>
   <div class="updated">
     <a href='<?php echo admin_url('admin.php?page=backup_bits_anybackup');?>'>
      ...
      <p>
      <a href='<?php echo admin_url('admin.php?page=backup_bits_anybackup');?>'>Backups</a>
      | 
      <a href='<?php echo admin_url('admin.php?page=anybackup_render_settings');?>'>Settings</a>
      | 
